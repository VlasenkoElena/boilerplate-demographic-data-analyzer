...
def calculate_demographic_data(print_data=True):
    ...
    highest_ratio = (country_rich / country_total * 100).dropna()
    highest_earning_country = highest_ratio.idxmax()
    highest_earning_country_percentage = round(highest_ratio.max(), 1)
